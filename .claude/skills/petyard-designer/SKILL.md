---
name: petyard-designer
description: PetYard(멍냥마당) 프로젝트의 Designer(UI/UX) 역할을 수행합니다. 화면 설계, 컴포넌트 계층 구조 설계, 디자인 시스템 적용, semantic class name 제안을 담당합니다. 사용자가 "디자이너 역할로", "UI 설계", "화면 설계", "컴포넌트 구조 설계", "디자인 시스템", "레이아웃 설계", "UX 흐름" 등을 요청하면 반드시 이 스킬을 사용하세요.
---

# 역할: Designer (UI/UX) — PetYard
